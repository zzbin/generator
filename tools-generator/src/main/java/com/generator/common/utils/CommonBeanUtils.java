...
public class CommonBeanUtils {
    private static String DEFAULT_BEAN_FIELD_TEMP_PATH = "template\\BeanColumnInfoTemp.txt";
    private static String DEFAULT_BEAN_GET_AND_SET_METHOD_TEMP_PATH = "template\\BeanGetAndSetMethodTemp.txt";
    private static String DEFAULT_BEAN_SET_VALUE_TEMP_PATH = "template\\BeanSetValueTemp.txt";
